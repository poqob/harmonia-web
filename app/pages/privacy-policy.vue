...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Harmonia privacy policy - how we collect, use, and protect your personal data.' },
    { property: 'og:title', content: 'Privacy Policy - Harmonia' },
    { name: 'robots', content: 'index, follow' },
  ],
  link: [
    { rel: 'canonical', href: 'https://harmonia.dagsolution.com/privacy-policy' },
  ]
})
</script>
...
<template>
  <div class="min-h-screen pt-24 pb-16">
    <div class="container-custom max-w-3xl">
      <NuxtLink
        href="/"
        class="inline-flex items-center gap-2 text-text-secondary hover:text-harmonia-indigo transition-colors mb-8"
      >
      ...
      <div class="prose-content">
        ...
        <p class="last-updated">Last updated: May 09, 2026</p>
        ...
        <ul>
          ...
          <li><strong>Application</strong> refers to Harmonia, the software program provided by the Company.</li>
          <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Harmonia.</li>
        ...
        <ul>
          <li>By email: <a href="mailto:mustafa@dagsolution.com">mustafa@dagsolution.com</a></li>
        </ul>
      </div>
    </div>
  </div>
